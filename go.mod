...
require (
	...
	github.com/mwitkow/go-proto-validators v0.3.2 // indirect; indirectdirect
	...
	github.com/pseudomuto/protokit v0.3.0 // indirect
	...
	go.etcd.io/etcd/etcdutl/v3 v3.7.2 // indirect
	go.etcd.io/etcd/pkg/v3 v3.7.2 // indirect
	go.etcd.io/etcd/tests/v3 v3.7.2 // indirect
